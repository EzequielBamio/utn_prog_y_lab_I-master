...
void List_Headboard()
{
	puts("\n[LISTA DE VUELOS]\n[*] C/P: CANTIDAD PASAJEROS - H/D: HORA DESPEGUE - H/L: HORA LLEGADA");
	printf("_______________________________________________________________________________________________________\n");
	printf("|             |              |                   |            |            |        |        |        |\n");
	printf("| ID VUELO    | ID AVIONO    | ID PILOTOO        | FECHA      | DESTINO    | C/P    | H/D    | H/L    |\n");
	printf("|_____________|______________|___________________|____________|____________|________|________|________|\n");
	printf("|             |              |                   |            |            |        |        |        |\n");
}
